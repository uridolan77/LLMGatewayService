...
public class ContentFilteringOptions
{
    ...
    /// <summary>
    /// Whether to use ML-based filtering
    /// </summary>
    public bool UseMLFiltering { get; set; } = false;

    /// <summary>
    /// Model ID to use for moderation
    /// </summary>
    public string? ModerationModelId { get; set; }

    /// <summary>
    /// Whether to fail open (allow) when moderation service fails
    /// </summary>
    public bool FailOpenOnModerationError { get; set; } = true;
}
